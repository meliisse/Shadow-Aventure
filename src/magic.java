...
public class magic extends Personnage {
    ...
    public void utiliserCompetence(Personnage cible) {
        this.pointsDeVie += 40;
        this.defence_factor += 9;
        this.degats += 0;
    }

    public boolean arena(Personnage guerrier, magic cible, Personnage mage, Personnage voleur) {
        ...
        while(joueur.estVivant() && cible.estVivant()) {
            try {
                ...
                System.out.printf("i know two mosnsters who know how to use pc bettre than u");
            }
